...
- https://github.com/nellimonix/warp-config-generator-vercel - генерация конфигов WARP на протоколе AmneziaWG, конфиги подходят только для AmneziaVPN и AmneziaWG (warp.llimonix.dev - сайт, https://t.me/warp_generator_bot - телеграмм бот)
